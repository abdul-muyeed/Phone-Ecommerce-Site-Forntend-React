    ...
    return (
        <>
            ...
            <div className="w-full md:w-1/2 p-4 md:p-8">
                <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-4">Signed Out</h1>
                <p className="text-lg md:text-xl text-gray-600 mb-8">Successfully! Signed Out. Go back to Home Page  </p>
