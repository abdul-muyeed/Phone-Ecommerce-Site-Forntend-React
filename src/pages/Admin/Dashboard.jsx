            ...
            <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                <div className="flex items-center">
                    ...
                    <div className="relative mx-4 lg:mx-0">
                        ...
                        <input className="w-32 pl-10 pr-4 rounded-md form-input sm:w-64 outline-none focus:border-indigo-600" type="text"
                            placeholder="Search"/>
                    </div>
                </div>
                ...
                <div className="flex items-center">
                    <div  className="relative">
                        ...
                        <div  className="fixed inset-0 z-10 w-full h-full hidden hover:block " ></div>
    
                        <div 
                            className="absolute right-0 z-10 mt-2 overflow-hidden bg-white rounded-lg shadow-xl w-80 hidden hover:block"
                            >
                            <a href="#"
                    ...
                    <div  className="relative">
                        ...
                        <div   className="fixed inset-0 z-10 w-full h-full hidden hover:block"
                            ></div>
    
                        <div 
                            className="absolute right-0 z-10 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl hidden hover:block"
                            >
                            <a href="#"
